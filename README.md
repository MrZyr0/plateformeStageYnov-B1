...
Dans le cadre du dernier projet de l'année 2017-2018, l'école [Ynov Campus de Lyon](http://ynovlyon.com/) demande aux étudiant **IngéSup** de première année (**B1**) de créer une plateforme **d'offres de stage inversées** qui aidera les entreprises à trouver des profils de stagiaire ou d'alternant chez **Ynov**.
...
Toute la classe des **B1** sont mobilisés en concurence par groupe de 3. Le site le plus abouti et adapté au cahier des charges se vérra intégré au site du [Campus Ynov de Lyon](http://ynovlyon.com).
